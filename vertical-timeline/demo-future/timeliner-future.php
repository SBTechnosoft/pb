...
<head>
	...
	<link rel="stylesheet" href="vertical-timeline/demo-future/css/timeliner-future.css" type="text/css" media="screen">
	<link rel="stylesheet" href="vertical-timeline/js/vendor/venobox/venobox.css" type="text/css" media="screen">
</head>
<body>
	<div class="container">
		<h1>Timeliner.js</h1>
		...
		<p class="lead">Example of the timeliner.js jquery plugin with advanced, custom theming. All theming accomplished with CSS and minor modifications to the HTML markup. No modifications to the plugin's core javascript. Note that this demonstration does not fully support older browsers (e.g, before Internet Explorer 9) due to the use of CSS3 properties.</p>
		...
		<div id="timeline" class="timeline-container">
			...
			<div class="timeline-wrapper">
				...
				<dl class="timeline-series">
					...
					<dt id="robots" class="timeline-event"><a href="">Robots</a></dt>
					<span class="tick tick-after"></span>
					<dd class="timeline-event-content" id="robotsEX">
						<div class="media">
							<a href="http://youtu.be/hUnibKe_o18" class="venobox" data-type="youtube" data-overlay="rgba(0,0,0,0.5)">
							<img src="vertical-timeline/demo-future/img/event-robots.jpg" alt="singing robots"></a>
			...
			<div class="timeline-wrapper">
				...
				<dl class="timeline-series">
					...
					<dd class="timeline-event-content" id="carsEX">
						<div class="media">
							<a href="http://youtu.be/FyinD6ZDqeg" class="venobox" data-type="youtube" data-overlay="rgba(0,0,0,0.5)">
							<img src="vertical-timeline/demo-future/img/event-cars.jpg" alt="flying car"></a>
					...
					<dd class="timeline-event-content" id="urbanityEX">
						<div class="media">
							<a href="http://discovermagazine.com/2012/oct/2062-the-state-of-the-world" class="venobox" data-type="iframe" data-overlay="rgba(0,0,0,0.5)">
							<img src="vertical-timeline/demo-future/img/event-urbanity.jpg" alt="jam packed city fuels tempers"></a>
			...
			<div class="timeline-wrapper">
				...
				<dl class="timeline-series">
					...
					<dd class="timeline-event-content" id="teleportEX">
						...
						<div class="media">
							<a href="https://www.teliportme.com/view/446746" class="venobox" data-type="iframe" data-overlay="rgba(0,0,0,0.5)">
							<img src="vertical-timeline/demo-future/img/event-teleportation.jpg" alt="teleporting humans"></a>
				...
				<dl class="timeline-series">
					...
					<dd class="timeline-event-content" id="singularityEX">
						...
						<div class="media">
							...
							<img src="vertical-timeline/demo-future/img/event-singularity.gif" alt="">
						</div><!-- /.media -->
