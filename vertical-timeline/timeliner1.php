...
<head>
	...
	<!--link rel="stylesheet" href="vertical-timeline/css/demo.css" type="text/css" media="screen">
	<link rel="stylesheet" href="vertical-timeline/css/timeliner.css" type="text/css" media="screen">
	<link rel="stylesheet" href="vertical-timeline/css/responsive.css" type="text/css" media="screen">
	<link rel="stylesheet" href="vertical-timeline/inc/colorbox.css" type="text/css" media="screen"-->
</head>
<body>
	<div class="container">
		<h1>Timeliner</h1>
			...
			<div class="timeline-wrapper">
				...
				<dl class="timeline-series">
					...
					<dd class="timeline-event-content" id="19550828EX">
						...
						<div class="media">
							<a href="#inline-1955-08-282" class="CBmodal">
							<img src="vertical-timeline/demo-future/img/event-cars.jpg" alt="Related Video: The Emmett Till Murder"></a>
						...
						<p>
							Fourteen-year-old African-American Emmett Till is brutally murdered after reportedly flirting with a white woman while visiting 
							relatives in Mississippi. For the first time, both black and white reporters cover the trial epitomizing "one of the most shocking
							and enduring stories of the twentieth century." The white defendants, Roy Bryant and J.W. Milam, are acquitted by an all-white 
							jury in only 67 minutes; later they describe in full detail to Look magazine (which paid them $4,000) how they killed Till.
							His mother insists on an open casket funeral, and the powerful image of his mutilated body sparks a strong reaction across the 
			...
			<div class="timeline-wrapper">
				...
				<dl class="timeline-series">
					...
					<dd class="timeline-event-content" id="19570904EX">
						...
						<div class="media">
							<a href="#inline-1957-09-044" class="CBmodal">
							<img src="http://img.youtube.com/vi/h148GEIgUeA/0.jpg" alt="Related Video: Reporting Little Rock"></a>
			...
			<div class="timeline-wrapper">
				...
				<dl class="timeline-series">
					...
					<dd class="timeline-event-content" id="19610504EX">
						...
						<div class="media">
							<a href="#inline-1961-05-045" class="CBmodal">
							<img src="http://img.youtube.com/vi/Sxe9dJoZ-AQ/0.jpg" alt="Related Video: Freedom Rides"></a>
			...
			<div class="timeline-wrapper">
				...
				<dl class="timeline-series">
					...
					<dd class="timeline-event-content" id="19630828EX">
						...
						<div class="media">
							<a href="#inline-1963-08-287" class="CBmodal">
							<img src="http://img.youtube.com/vi/gvAQE66jwcg/0.jpg" alt="Related Video: Black Press"></a>
			...
			<div class="timeline-wrapper">
				...
				<dl class="timeline-series">
					...
					<dd class="timeline-event-content" id="19640702EX">
						<h3>July 2, 1964</h3>
						<p>
							President Lyndon B. Johnson signs the Civil Rights Act of 1964, mandating equal opportunity employment, and complete desegregation 
							of schools and other public facilities. It also outlaws unequal voter registration requirements. Although it would take years for 
							these changes to take effect in communities around the country, the law is a monumental victory for the civil rights movement.
						</p>
