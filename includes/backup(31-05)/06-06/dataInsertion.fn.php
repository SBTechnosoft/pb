...
function insCatg($conn,$txtcatgnm,$txtcatgdes)
		{
			$sqlInsCatg = "INSERT INTO `eq_category_mst` (`cat_name`,`description`) VALUES ('".$txtcatgnm."','".$txtcatgdes."')"; 
			$resultArray = $conn->insertQuery($sqlInsCatg);
			echo 0;
			exit;
		}
function insAcs($conn,$txtcatid,$txtacsnm,$txtacsremk)
		{
			$sqlInsAcs = "INSERT INTO `eq_accessories` (`eq_id`,`as_name`,`remark`) VALUES ('".$txtcatid."','".$txtacsnm."','".$txtacsremk."')"; 
...
function insVend($conn,$txtvendnm,$drp_cat_vend,$txtvendcmp)
		{
			$sqlInsVend = "INSERT INTO `vendor_mst` (`vendor_name`,`cat_id`,`vendor_cmp`) VALUES ('".$txtvendnm."','".$drp_cat_vend."','".$txtvendcmp."')"; 
...
function insEqup($conn,$txteqpnm,$txtserno,$txtmodel,$txtcateqp,$txtpurdate,$txtpurfrm,$txtremk,$txtprice)
		{
			$sqlInsEqup = "INSERT INTO `equipment_mst` (`eq_name`,`serial_no`,`model_no`,`category_id`,`purchase_date`,`purchase_from`,`eq_photo`,`remark`,`price`)VALUES ('".$txteqpnm."','".$txtserno."','".$txtmodel."','".$txtcateqp."','".$txtpurdate."','".$txtpurfrm."','".$txtremk."','".$txtremk."','".$txtprice."')"; 
...
function insertEventAdd($conn,$txteventnm,$txteventds,$txtclnm,$txtclcmp,$txtclemail,$txtworkmob,$txthmmob,$txtmob,$txtcharge,$txtpaid,$fromdate,$todate,$status,$cur_date,$pay_status,$drpcmpnm,$taxmode,$txtbillno,$txtfpno,$tax,$gtot,$txtstax)
		{
			...
			VALUES ('".$txteventnm."','".$txteventds."','".$txtclnm."','".$txtclcmp."','".$txtclemail."','".$txtworkmob."','".$txthmmob."','".$txtmob."','".$status."','".$fromdate."','".$todate."','".$pay_status."','".$txtcharge."','".$txtpaid."','".$cur_date."','','','".$drpcmpnm."','".$taxmode."','".$txtbillno."','".$txtfpno."','".$tax."','".$gtot."','".$txtstax."')"; 
...
function insCmpNew($conn,$txtcmpnm,$txtcmprno)
		{
			$sqlInsCmp = "INSERT INTO `company_mst` (`cmp_name`,`cmp_reg_no`) VALUES ('".$txtcmpnm."','".$txtcmprno."')"; 
			$resultArray = $conn->insertQuery($sqlInsCmp);
			echo 1;
			exit;
		}
...
function insNewEventPlac($conn,$event_id,$event_plc_id,$txtieqp,$txtirate,$txtiqty,$txtiamt,$txtistf,$txtivend,$txtivendprice,$txtiremark)
		{
			$sqlinsNewEventPlac = "INSERT INTO `new_event_places_dtl` (`event_id`,`event_places_id`,`eq_id`,`rate`,`qty`,`amount`,`staff_id`,`vend_id`,`vend_price`,`remark`) 
				VALUES ('".$event_id."','".$event_plc_id."','".$txtieqp."','".$txtirate."','".$txtiqty."','".$txtiamt."','".$txtistf."','".$txtivend."','".$txtivendprice."','".$txtiremark."')"; 
