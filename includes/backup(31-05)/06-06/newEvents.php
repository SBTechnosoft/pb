					...
					<form action="#" name="Form" class="form-horizontal" role="form" >
						...
						<!--New pop up for insert the vendor -->
								...
								<div>
									...
									<input style="width:120px;" type="text"  value="Staff" readonly />
									<input style="width:110px;" type="text"  value="Vendor" readonly />
									...
									<!--input style = "width :120px;" type="text"  value="Remark" readonly /-->
								</div>
								
								<div>
									<select  name="drpneweqp" id="drpneweqp" class="medium m-wrap drpneweqp">											
									</select>
									<input class="small m-wrap txtrate"  type="text"  id="txtrate" name="txtrate" value="" readonly />
									...
									<select name="drpnewstf" id="drpnewstf" class="small m-wrap drpnewstf"> 											
									</select>
									<select name="drpnewvend" id="drpnewvend" class="small m-wrap drpnewvend"> 											
									</select>
									<input class="small m-wrap txtvprice" type="text"  id="txtvprice" name="txtvprice" value="" />
									<!--textarea rows="4" cols="50" id="txtremark" class="txtremark" name="txtremark"></textarea>
									<a name="addeqp" id="addeqp" style= "cursor:pointer;">
										Add								
									</a-->
								</div>
								<div>
								...
								<div>
									<textarea rows="2" cols="150" id="txtremark" class="txtremark" name="txtremark"></textarea>
