...
function showClientPaidAmt($conn)
	{
		$sqlClPaidAmt = "select `event_id`,`event_name`,`client_name`,`client_work_mob`,`client_charges`,`client_paid_amt`,`client_discount_amt`,`total_amt` from `event_mst` where `payment_status` = 'Paid' and `status` != 'enquiry' "; 
		return $conn->getResultArray($sqlClPaidAmt);	
	}
function showClientUnpaidAmt($conn)
	{
		$sqlClPaidAmt = "select `event_id`,`event_name`,`client_name`,`client_work_mob`,`client_charges`,`client_paid_amt`,`total_amt` from `event_mst` where `payment_status` = 'Unpaid' and `status` != 'enquiry' "; 
		return $conn->getResultArray($sqlClPaidAmt);	
	}
