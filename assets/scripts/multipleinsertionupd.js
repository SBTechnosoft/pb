		...
		'{'+
			...
			'var div =	'+				
					...
					'\'<tr id="eqrow\'+i+\'\'+j+\'">\'+'+
						...
						'\'<input   type="hidden" class="txtiuamt"  id="hdn[\'+col+\'][\'+row'+i+'+\'][txtiamt]" name="hdn[\'+col+\'][\'+row'+i+'+\'][txtiamt]" value="\'+amt+\'">\'+'+
						...
						'\'<input  type="hidden" class="txtiuvendprice" id="hdn[\'+col+\'][\'+row'+i+'+\'][txtivendprice]" name="hdn[\'+col+\'][\'+row'+i+'+\'][txtivendprice]" value="\'+vprice+\'">\'+'+
